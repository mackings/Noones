...
const { getMultiplenoonesOffers, updatenoonesPricesForAllAccounts, updatenoonesOffersForSpecificAccount } = require('../controllers/Rate Config/flash Offer/noones');
